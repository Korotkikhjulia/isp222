...
Route::get('/home/shab', [HomeController::class, 'shab'])->name('home.shab');
Route::post('/home/shab', [HomeController::class, 'shab2'])->name('shab.store');
...
Route::get('/enter/create', [EnterController::class, 'create'])->name('enter.create');
Route::post('/enter', [EnterController::class, 'enter'])->name('enter.store');
...
// Route::get('/post/all', [ArtController::class, 'getAll']);
